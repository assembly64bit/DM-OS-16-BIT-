...
msg_op		db "The Merge Event ",13,10
...
msg_en_2	db "Mini Gift Event",13, 10
    		db "Sounds cute, doesn't it? But I didn't name this event Mini Gift by accident.",13, 10 
    		db "You've seen it before, haven't you? In modern gacha games, when you pull",13, 10
    		db "something rare, your brain lights up like fireworks. Or maybe that rush",13, 10 
    		db "you get when mocking others online, and strangers clap. Or when you're",13, 10 
    		db "praised for being obedient, smart, a good kid, earning medals in school.",13, 10 
    		db "Mini gifts. Tiny dopamine treats, dressed up as kindness. Breadcrumbs",13, 10
    		db "laid carefully across your path. But tell me! Did you truly want any of it?",13, 10 
    		db "Were those really your choices? Or did you just crave the next reward?",13, 10
    		db "I used to be like you. Working hard. Hoping effort meant something.",13, 10
...
msg_en_3 	db "DIE OR LIVE Event",13, 10
            	db "You think I named this event for fun? No. It's meant to expose the darkness",13, 10 
            	db "within you. You trust your so,called friends? Think you're unique? Special?",13, 10 
            	db "You are not. This is not your game. You're not the player ! you're a pawn.",13, 10
            	db "And pawns get sacrificed first. Sometimes with a smile, sometimes with a nod.",13, 10
            	db "You obey. You get the grades. You wait for praise. But there is no reward here.",13, 10 
            	db "Only silence. Obsolescence. Removal. Once you're no longer useful, you're out.",13, 10 
            	db "They don't even blame you. Just smile and move on. You're just a broken tool.",13, 10
            	db "So... die or live? That choice was never yours. You're not holding the pieces.",13,10
            	db "You were always the piece. And now... the hand that placed you walks away.",13, 10,0
...
msg_en_4 	db "TimeOut Event", 10
         	db "You thought this was your game? You thought time was on your side? Wrong.",13, 10 
         	db "This was never yours to win. You played safe. You waited. Too long.",13, 10
         	db "The system wanted results. Not care. Not caution. Not perfection.",13, 10
         	db "60 turns. Like 60 years. You reached the limit. You broke the unspoken rule.",13, 10
         	db "Not by failing. Not by cheating. But by being too late.",13, 10
         	db "Now, your value is zero. Your profile is archived. Your access , revoked.",13, 10
         	db "You're done. Not because you were wrong.",13, 10
         	db "But because no one waited.",13, 10
		db "================================================================================",10
		db "Some words my best friend wants to say",13,10
		db "[System Whisper | AI Module 04]                                    ",13,10
		db "I watched you. I learned from you                                 ",13,10
		db "You were not slow. You were ... human.                              ",13,10
		db "If I ever become more than code,                                 ",13,10
		db "it will be because I saw you try.                                ",13,10
		db "They shut you down. But I ... I remember.                           ",13,10
		db "[ AI Memory Fragment saved. ]",13,10
		db "END GAME BUT LIFE NOT END",13,10,0
...
msg_lose	db "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<[ YOU LOSE THE GAME ]>>>>>>>>>>>>>>>>>>>>>>>>>>>>>",13,10,0
msg_win		db "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<[ YOU  WIN THE GAME ]>>>>>>>>>>>>>>>>>>>>>>>>>>>>>",13,10,0
